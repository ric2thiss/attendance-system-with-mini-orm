                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-100 flex flex-col justify-between">
                        <div>
                            ...
                            <div class="flex items-center justify-between mb-4">
                                <span class="text-5xl font-bold text-blue-600"><?= $totalResidents ?></span>
                            ...
                            <p class="text-sm text-gray-500 mb-4">Registered residents in the system</p>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-100 flex flex-col justify-between">
                        <div>
                            ...
                            <div class="flex items-center justify-between mb-4">
                                <span class="text-5xl font-bold text-indigo-600"><?= $totalEmployees ?></span>
                            ...
                            <p class="text-sm text-gray-500 mb-4">Active employees in the system</p>
